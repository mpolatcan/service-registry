...
func (observer *Observer) StartObserver(registryAddr string, observedServices string, observerHostname string, observerPort int, observerUpdateEndpoint string, updaterFunction func(r *http.Request), extraHandlers ...ObserverHandler) {
